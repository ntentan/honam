...
class PhpEngineFactory implements EngineFactoryInterface
{
    ...
    public function __construct(TemplateRenderer $templateRenderer, HelperVariable $helperFactory)
    {
    ...
    {
        return new PhpEngine($this->templateRenderer, $this->helperVariable);
    }
}
